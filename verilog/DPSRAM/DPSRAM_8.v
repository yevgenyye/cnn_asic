...
//*#
//*#        Library Name   : tsdn28hpca256x8m8fw
//*#        Library Version: 170a
//*#        Generated Time : 2020/02/20, 13:51:12
//*###############################################################################
//*#
//*# STATEMENT OF USE
//*#
...
parameter cdeFileInit  = "TSDN28HPCA256X8M8FW_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TSDN28HPCA256X8M8FW_fault.cde";
`endif
...
reg valid_da7, valid_da6, valid_da5, valid_da4, valid_da3, valid_da2, valid_da1, valid_da0;
reg valid_db7, valid_db6, valid_db5, valid_db4, valid_db3, valid_db2, valid_db1, valid_db0;
reg valid_bwa7, valid_bwa6, valid_bwa5, valid_bwa4, valid_bwa3, valid_bwa2, valid_bwa1, valid_bwa0;
reg valid_bwb7, valid_bwb6, valid_bwb5, valid_bwb4, valid_bwb3, valid_bwb2, valid_bwb1, valid_bwb0;
...
thold = 0.3718716;
   ...
   $recrem (posedge CLKB, posedge CLKA &&& BbeforeA, tcc, 0, valid_contentionb);
    ...
    $setuphold (posedge CLKA &&& WEA, posedge BWEBA[4], tbws, tbwh, valid_bwa4);
    $setuphold (posedge CLKA &&& WEA, negedge BWEBA[4], tbws, tbwh, valid_bwa4);
    $setuphold (posedge CLKB &&& WEB, posedge BWEBB[4], tbws, tbwh, valid_bwb4);
    $setuphold (posedge CLKB &&& WEB, negedge BWEBB[4], tbws, tbwh, valid_bwb4);
    ...
    $setuphold (posedge CLKA &&& WEA, posedge BWEBA[5], tbws, tbwh, valid_bwa5);
    $setuphold (posedge CLKA &&& WEA, negedge BWEBA[5], tbws, tbwh, valid_bwa5);
    $setuphold (posedge CLKB &&& WEB, posedge BWEBB[5], tbws, tbwh, valid_bwb5);
    $setuphold (posedge CLKB &&& WEB, negedge BWEBB[5], tbws, tbwh, valid_bwb5);
    ...
    $setuphold (posedge CLKA &&& WEA, posedge BWEBA[6], tbws, tbwh, valid_bwa6);
    $setuphold (posedge CLKA &&& WEA, negedge BWEBA[6], tbws, tbwh, valid_bwa6);
    $setuphold (posedge CLKB &&& WEB, posedge BWEBB[6], tbws, tbwh, valid_bwb6);
    $setuphold (posedge CLKB &&& WEB, negedge BWEBB[6], tbws, tbwh, valid_bwb6);
    ...
    $setuphold (posedge CLKA &&& WEA, posedge BWEBA[7], tbws, tbwh, valid_bwa7);
    $setuphold (posedge CLKA &&& WEA, negedge BWEBA[7], tbws, tbwh, valid_bwa7);
    $setuphold (posedge CLKB &&& WEB, posedge BWEBB[7], tbws, tbwh, valid_bwb7);
    $setuphold (posedge CLKB &&& WEB, negedge BWEBB[7], tbws, tbwh, valid_bwb7);
...
TSDN28HPCA256X8M8FW_Int_Array #(2,2,W,N,M,MES_ALL) MX (.D({DAL,DBL}),.BW({BWEBAL,BWEBBL}),
...
module TSDN28HPCA256X8M8FW_Int_Array (D, BW, AW, EN, AAR, ABR, RDA, RDB, QA, QB);
